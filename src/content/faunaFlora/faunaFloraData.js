export const faunaData = [
  {
    ...
    relatedContent: {
      ...
      flora: [
        { label: "Fitoplâncton", id: "fitoplancton" }
      ]
    },
    location: {
  ...
  },
  {
    ...
    location: {
      ...
      description: "Comum na costa da África do Sul, Austrália, Califórnia e Mediterrâneo."
    },
  ...
  },
  {
    ...
    location: {
      ...
      description: "Desova em praias do litoral brasileiro, especialmente em áreas protegidas como o Projeto Tamar."
    },
  ...
  // --- NOVOS ITENS DE FAUNA ---
  {
    ...
    location: {
      ...
      description: "Encontrado em recifes de coral, fundos rochosos e prados de ervas marinhas em todo o mundo."
    },
  ...
  },
  {
    ...
    location: {
      ...
      description: "Habita águas quentes dos oceanos Pacífico e Índico, incluindo o Mar Vermelho."
    },
  ...
  },
  {
    ...
    shortDescription: 'A guardiã das florestas de kelp e o mamífero com a pelagem mais densa.',
    ...
    location: {
      ...
      description: "Encontrada desde o norte do Japão, passando pela costa da Rússia, Alasca, até a Califórnia."
    },
  ...
  },
  {
    ...
    geologicalPeriodId: 'paleogeno',
    shortDescription: 'O maior peixe do mundo, um gigante gentil que se alimenta por filtração.',
    ...
    location: {
      ...
      description: "Encontrado em oceanos abertos, com grandes agregações sazonais em locais como México, Filipinas e Austrália."
    },
...
export const floraData = [
  {
    ...
    details: [
      ...
      { title: "Ecologia", text: "A saúde das florestas de kelp está diretamente ligada a predadores como as lontras-marinhas, que controlam as populações de ouriços-do-mar." }
    ],
    ...
    location: {
      ...
      description: "Florestas de kelp são comuns ao longo da costa do Pacífico, especialmente na Califórnia, e em outras regiões de águas frias."
    },
  ...
  },
  {
    ...
    location: {
      ...
      description: "Encontrados em todos os mares e oceanos onde há luz solar para a fotossíntese."
    },
  ...
  },
  {
    ...
    label: 'Grama Marinha',
    geologicalPeriodId: 'cretaceo',
    shortDescription: 'Plantas que formam prados submersos, essenciais para a saúde costeira.',
    longDescription: 'A grama marinha não é uma alga, mas sim uma planta com flores que vive totalmente submersa. Os prados de grama marinha são habitats incrivelmente importantes, funcionando como berçários para peixes, estabilizando o sedimento para proteger as costas da erosão e sequestrando grandes quantidades de carbono.',
    details: [
    ...
    location: {
      ...
      description: "Comuns em regiões costeiras protegidas de águas rasas em todos os continentes, exceto na Antártida."
    },
    duration: "Perene",
  },
  ...
  // --- NOVOS ITENS DE FLORA ---
  {
    ...
    shortDescription: 'As "cidades" subaquáticas, ecossistemas vibrantes construídos por pequenos animais.',
    ...
    location: {
      ...
      description: "Encontrados em águas quentes, claras e rasas ao redor do equador, como na Grande Barreira de Corais da Austrália."
    },
  ...
  },
  {
    ...
    shortDescription: 'Predador séssil com tentáculos venenosos que serve de lar para certas espécies.',
    ...
    location: {
      name: "Todos os Oceanos",
      description: "Habitam desde poças de maré costeiras até as profundezas abissais."
    },
  ...
  },
  {
    ...
    label: 'Manguezais',
    geologicalPeriodId: 'cretaceo',
    shortDescription: 'Florestas costeiras tolerantes ao sal que são vitais como berçários marinhos.',
    ...
    location: {
      ...
      description: "Encontrados em zonas de transição entre o rio e o mar em países como Brasil, Indonésia e Nigéria."
    },
  ...
  },
  {
    ...
    label: 'Sargaço',
    geologicalPeriodId: 'neogeno',
    shortDescription: 'Alga marrom flutuante que forma vastos "mares" dourados no oceano aberto.',
    ...
    location: {
      ...
      description: "Principalmente no Mar dos Sargaços, mas grandes massas flutuantes podem ser encontradas em todo o Atlântico tropical."
    },
    duration: "Variável",
  }
];